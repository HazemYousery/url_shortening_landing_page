...
<div class="jumbotron-fluid">
    <div class="row">
        ...
        <div class="col-6">
           <img src="https://cdn.dribbble.com/users/4828924/screenshots/11711486/media/d81302f99608cb0ec1232d1ec7fcbd6a.png?resize=400x0">
        </div>
    </div>
</div>
    ...
    <div class="card" id="hazem">
        <div class="card-body" >
<form onsubmit="handleSubmit">
<div class="row">
<div class="col-10">
            <input type="url" placeholder="shorten a link here" id="searchBar">
</div>
    <div class="col-2">
            <button id="searchBtn" type="button" onclick="handlechange">Shorten it</button>
    </div>
</div>
</form>
</div>
...
<h3>Advanced Statistics</h3>
    <p id="pas">Track How our links are performing across the web with our advanced statistics dashboard</p>
</div>
<br>
<br>
<div class="row">
...
<h3>Brand recognition</h3>
            <p>boost your brand recognition with each click.generic links don't a thing.branded links help install confidence in your content</p>
        </div>
    </div>
...
<div class="row">
    <div class="card" id="cardx">
        <div class="card-body">
            ...
            <button id="btnB">Get started</button>
        </div>
    </div>
</div>
