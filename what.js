...
<div className="row">
   <div className="card" id="cardx">
       <div className="card-body">
           ...
           <button id="btnB" className="NM">Get started</button>
       </div>
   </div>
</div>

   <div className="card" id="cardy">
       <div className="card-body">
           <div className="F">

              <b>Features</b>
              <b  className="R">Resources</b>
              <b>Company</b>
              </div>
              ...
              <br />
               ...
               <div >  
               <b className="L">Link shortening</b>
               <b className="B">Blog</b>
               <b>About</b>
               </div>
               <br />
               <br />
...
<div className="A">
                   <b>analytics</b>
                   <b  className="D">Developers</b>
                   <b>Careers</b>
</div>
             


               <div className="C"><p>Contact</p></div>
               <div >
